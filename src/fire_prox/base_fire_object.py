...
from typing import Any, Dict, Generic, Optional, Set, overload
...
class BaseFireObject(Generic[SchemaT_co]):
    ...
    @overload
    def collection(self, name: str, schema: SchemaType[SchemaT]) -> Any:
        ...
    ...
    def collection(
        ...
        Args:
            schema: Optional dataclass schema to bind immediately. When provided,
                the resulting collection returns typed documents for static
                analysis.
